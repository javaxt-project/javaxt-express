...
public class ServiceRequest {
  ...
  //** getFields
  //**************************************************************************
  /** Returns an array of Fields found in the "fields" parameter in the HTTP
   *  request. Any fields that contain functions are evaluated to see if they
   *  are safe (e.g. "min", "max", "count", "avg", "sum").
   */
  ...
  //** getFilter
  //**************************************************************************
  /** Returns a Filter associated with this request. The Filter can be used to
   *  generate a "where" clause for a SQL query. If a "filter" JSON object is
   *  found in the request, it will be parsed into a Filter. Otherwise, the
   *  Filter is generated by parsing the query string in the URL. Examples:
   *  <ul>
  ...
  //** Filter Class
  //**************************************************************************
  /** Used to encapsulate an "where" statement
   */
    public class Filter {
